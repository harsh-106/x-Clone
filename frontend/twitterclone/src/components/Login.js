      ...
      <div className="flex items-center justify-evenly w-[80%]">
        ...
        <div>
          ...
          <form onSubmit={submitHandler} className="flex flex-col w-[55%]">
            ...
            <h1>
              { isLogin ? "Don't have an account?" : "Already have an account?"} <span onClick={loginSignUpHandler} className="font-bold text-blue-600 cursor-pointer">{isLogin ? "Register" :  "Login"}</span>{" "}
            </h1>
          </form>
        </div>
      </div>
